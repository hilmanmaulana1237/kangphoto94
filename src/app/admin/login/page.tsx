      ...
      <div className="w-full max-w-md bg-neutral-900/40 backdrop-blur-2xl border border-neutral-800 p-8 md:p-10 rounded-[2.5rem] shadow-[0_0_60px_rgba(0,0,0,0.8)] relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="mb-10 text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand-black border border-neutral-800 mb-6 shadow-xl">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-black/60 border border-neutral-800 rounded-2xl pl-12 pr-5 py-4 text-white placeholder-brand-gray/30 focus:outline-none focus:border-brand-tosca transition-all font-light tracking-widest"
                  placeholder="••••••••••••"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 w-full py-4 rounded-2xl bg-brand-tosca text-white font-semibold text-base hover:bg-brand-darkTosca transition-all flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(21,154,156,0.3)] disabled:opacity-50 disabled:cursor-not-allowed group"
            >
